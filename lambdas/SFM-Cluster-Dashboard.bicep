...
output dash array = filter(LogsDashboardParts, part => part.ha != 1 )
output mon array = filter(MonitorChartParts, part => part.ha != 1 )
output iframe array = filter(IFrameParts, part => part.ha != 1 )
output markdown array = filter(MarkdownParts, part => part.ha != 1 )
